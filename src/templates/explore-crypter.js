...
const Cards = (props) => {
   ...
   let start_index = 0;
   let end_index = props.indexEnd - 1;
   for (var i = start_index; i <= end_index; i++) {
	    let world_nft = props.filtered[i];
		//card_elems.push(<Card id={world_nft.id} image={world_nft.image} world_type={world_nft.world_type} />);
		if(world_nft) {
			//console.log("Adding index: " + i + ", World NFT ID: "+world_nft.id);
...
const ExploreCrypter = ({ pageContext: { spacebudz, initialOrder }, location }) => {
  ...
  const loadMore = () => {
	let curr_loadUntilIndex = loadUntilIndex;
	curr_loadUntilIndex += 50;
	console.log(curr_loadUntilIndex);
	setloadUntilIndex(curr_loadUntilIndex);
  }
  ...
  const applySearch = async () => {
	...
	const world_type = urlParams.get("world_type");
	const terrain_trait = urlParams.get("terrain_trait");
    const searchString = (
      id +
      types +
      gadgets +
  ...
  return (
    <StoreProvider store={store}>
		...
		<div className="outer__inner">
			<div className="section-pt80 catalog">
			  {/* Begin Catalog */}
			  <div className="catalog__center center">
				<div className="catalog__top">
				  <div className="catalog__title">Type your keywords</div>
				...
				<div className="catalog__sorting">
				  ...
				  {/* 
				  <div className="catalog__nav"><a className="catalog__link active" href="#">All items</a><a className="catalog__link" href="#">Inner World</a><a className="catalog__link" href="#">Outer World</a></div> */}
				</div>
				<div className="catalog__row">
				  <div className="catalog__filters">
					...
					>
					  <svg className="icon icon-close-circle-fill">
				  ...
				  <div className="catalog__wrapper">
					...
					<div className="catalog__btns">
					  <button className="button-stroke catalog__button" onClick={() => loadMore()}>Load more</button>
					</div>
				  </div>
				</div>
			  </div>
