				...
				<div className="item__bg">
				  ...
				  <div className="options">
					<div className="options__list">
					  <button className="button-circle-stroke options__button options__button_share js-options-share">
						<svg className="icon icon-share">
						  <use xlinkHref="#icon-share"></use>
						</svg>
					  </button>
					  <button className="button-circle-stroke options__button options__button_favorite active">
						<svg className="icon icon-heart">
						  <use xlinkHref="#icon-heart"></use>
						</svg>
					  </button>
					  <div className="actions js-actions">
						<button className="button-circle-stroke actions__button js-actions-button">
						  <svg className="icon icon-more">
							<use xlinkHref="#icon-more"></use>
						  </svg>
						</button>
						<div className="actions__body js-actions-body"><a className="actions__item js-popup-open" href="#popup-price" data-effect="mfp-zoom-in">
							<svg className="icon icon-coin">
							  <use xlinkHref="#icon-coin"></use>
							</svg>Change price</a><a className="actions__item js-popup-open" href="#popup-transfer" data-effect="mfp-zoom-in">
							<svg className="icon icon-arrow-right-square">
							  <use xlinkHref="#icon-arrow-right-square"></use>
							</svg>Transfer token</a><a className="actions__item js-popup-open" href="#popup-remove" data-effect="mfp-zoom-in">
							<svg className="icon icon-close-circle">
							  <use xlinkHref="#icon-close-circle"></use>
							</svg>Remove from sale</a><a className="actions__item js-popup-open" href="#popup-burn" data-effect="mfp-zoom-in">
							<svg className="icon icon-close-circle">
							  <use xlinkHref="#icon-close-circle"></use>
							</svg>Burn token</a><a className="actions__item js-popup-open" href="#popup-report" data-effect="mfp-zoom-in">
							<svg className="icon icon-info-circle">
							  <use xlinkHref="#icon-info-circle"></use>
							</svg>Report</a></div>
					  </div>
					</div>
					<div className="options__box js-options-box">
					  <div className="options__stage">Share link to this page</div>
					  <div className="options__share share-btn" data-url="https://ui8.net"><a className="options__direction btn-twitter" data-id="tw"><span>
							<svg className="icon icon-twitter">
							  <use xlinkHref="#icon-twitter"></use>
							</svg></span></a><a className="options__direction btn-facebook" data-id="fb"><span>
